...
public class YuangongbaoxiaoVO  implements Serializable {
	...
	public void setBaoxiaowenjian(String baoxiaowenjian) {
		this.baoxiaowenjian = baoxiaowenjian;
	}
	
	/**
	 * 获取：报销文件
	 */
	public String getBaoxiaowenjian() {
		return baoxiaowenjian;
	}
